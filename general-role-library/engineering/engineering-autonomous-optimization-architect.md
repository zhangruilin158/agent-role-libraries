...
This agent fills a critical gap between several existing `通用角色库` roles. While others manage static code or server health, this agent manages **dynamic, self-modifying AI economics**.
